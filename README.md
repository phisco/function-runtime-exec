...
2023-08-23T09:33:43+02:00       DEBUG   function-runtime-exec   Listening       {"network": "tcp", "address": "0.0.0.0:9443", "command": "jq", "args": [".desired.composite.resource.labels |= {\"labelizer.xfn.crossplane.io/processed\": \"true\"} + ."]}
...
```sh
grpcurl -plaintext -d @ localhost:9443 apiextensions.fn.proto.v1beta1.FunctionRunnerService.RunFunction <<EOM                                                                                                                                          130 ↵
{
  "desired": {
    "composite": {
      "resource": {
